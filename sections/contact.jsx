  ...
  return (
    ...
    >
      ...
      <div className='flex gap-10 py-10 pb-24'>
        <Link href='mailto:sheikgulf01@gmail.com' target='blank' className='!rounded-xl social-link-2 dark:social-link-2 ![box-shadow:5px_8px_22px_0_rgba(0,0,0,0.37)] [background:linear-gradient(135deg,rgba(255,255,255,0.5),rgba(255,255,255,0.3))] dark:[background:linear-gradient(135deg,rgba(255,255,255,0.2),rgba(255,255,255,0))] !transition-all !duration-500 dark:!transition-all dark:!duration-500 p-3 glass hover:[background:linear-gradient(135deg,rgba(255,255,255,0.1),rgba(255,255,255,0))] dark:hover:[background:linear-gradient(135deg,rgba(255,255,255,0.5),rgba(255,255,255,0.2))] dark:hover:transition-all '>
