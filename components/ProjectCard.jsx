...
const ProjectCard = ({ title, desc, imgUrl, github, liveSite }) => {
  return (
    <motion.div layout className='glass relative [background:linear-gradient(135deg,rgba(255,255,255,0.5),rgba(255,255,255,0.3))] dark:[background:linear-gradient(135deg,rgba(255,255,255,0.2),rgba(255,255,255,0))] !transition-colors !duration-1000 dark:!transition-all dark:!duration-500 project-card w-[280px] h-[40vh] md:h-[50vh] p-5 flex flex-col hover:cursor-pointer social-link-3 dark:social-link-3'>
